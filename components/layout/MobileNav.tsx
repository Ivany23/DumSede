  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Top Bar */}
          <div className="flex items-center justify-between border-b border-[#0B1B3A]/10 pb-6">
            <div className="flex items-center gap-3">
              <span className="text-2xl font-black tracking-widest text-gold-gradient font-serif">
                DUM
              </span>
              <span className="text-xs text-[#0066FF] border-l border-[#0066FF]/30 pl-3 uppercase tracking-wider">
                Sociedade Lda
              </span>
            </div>
